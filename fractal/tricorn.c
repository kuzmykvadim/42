...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/24 19:23:42 by vkuzmyk           #+#    #+#             */
/*   Updated: 2017/03/24 19:26:12 by vkuzmyk          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calc_tricorn(t_env *e, t_fractal *ftl)
{
...
void	put_tricorn(t_env *e, t_fractal *ftl)
{
	ftl->x = ftl->real.x;
	ftl->y = ftl->real.y;
